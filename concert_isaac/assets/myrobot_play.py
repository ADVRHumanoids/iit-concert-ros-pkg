...
_CONCERT_CONFIG_NAME = "myrobot"
_CONCERT_USD = os.path.join(
    _ASSETS_DIR, "usd", _CONCERT_CONFIG_NAME, f"{_CONCERT_CONFIG_NAME}.usd"
)
_CONCERT_URDF = os.path.join(
    _ASSETS_DIR, "urdf", f"{_CONCERT_CONFIG_NAME}.urdf"
)
_CONCERT_SRDF = os.path.join(
    _ASSETS_DIR, "srdf", f"{_CONCERT_CONFIG_NAME}.srdf"
)
