...
##
# USD path resolution
# The canonical deployment USD lives in the sibling concert_usd package so the
# repository mirrors the Kyon layout (kyon_isaac + kyon_urdf/kyon_srdf).
##
_ASSETS_DIR = os.path.abspath(os.path.dirname(__file__))
_PKG_ROOT = os.path.abspath(os.path.join(_ASSETS_DIR, "..", "..", "..", "..", ".."))
...
if not os.path.exists(_CONCERT_USD):
    raise FileNotFoundError(
        ...
        "The canonical asset set lives under concert_usd/usd."
    )
